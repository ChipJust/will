...
3. Writes a dated file to `will/reflections/YYYY-MM-DD-<repo>.md`
...
See `problems/` directory. Current:
...
- **Skills:** `~/.claude/plugins/marketplaces/claude-plugins-official/plugins/`
