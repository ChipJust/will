...
*(one entry per red/green/refactor cycle)*

### Deferred

*(list of skipped behaviors with reason)*

### Operational notes

*(deploy instructions, env vars, runbook entries — captured here, graduated to a separate ops doc when warranted)*
